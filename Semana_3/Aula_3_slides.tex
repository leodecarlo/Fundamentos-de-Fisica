...
\title{Aula 2B: Vetores em duas dimensoes}
\subtitle{}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.55\textwidth}
			\begin{tikzpicture}[scale=0.85]
				...
				\draw[thick, ->] (0,0) -- (-2,1.5) node[midway, above right] {$\overline{v}$};
				...
				\node[text width=3.5cm, align=left, font=\scriptsize] (t2) at (2.5, -2) {$\varphi$ é o angulo antihorario \\ a partir do vetor'$\overline{v}$'.};
